...
})({"4XJ4A":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "193fdc64246180c7";
...
},{}],"faQa2":[function(require,module,exports) {
...
loadTable();
function loadTable() {
    cronTasksTable = (0, _jqueryDefault.default)("#tblCronTasks").DataTable({
        // data: data,
        ...
        columns: [
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    ...
                    return data.isActive ? '<input class="btn btn-stop" type="button" value="Stop">' : '<input class="btn btn-activate" type="button" value="Activate">';
                }
            }
        ],
        order: [
    ...
    (0, _jqueryDefault.default)("#tblCronTasks tbody").on("click", ".btn-task-data", function() {
    ...
    (0, _jqueryDefault.default)("#tblCronTasks tbody").on("click", ".btn-result", function() {
        var tr = (0, _jqueryDefault.default)(this).closest("tr");
        var row = cronTasksTable.row(tr);
        var btn = this;
        // var btn = $(this).find('input')
    ...
    (0, _jqueryDefault.default)("#tblCronTasks tbody").on("click", ".btn-stop", function() {
        var tr = (0, _jqueryDefault.default)(this).closest("tr");
        var row = cronTasksTable.row(tr);
        stopTask(row.data());
    });
    (0, _jqueryDefault.default)("#tblCronTasks tbody").on("click", ".btn-activate", function() {
        var tr = (0, _jqueryDefault.default)(this).closest("tr");
        var row = cronTasksTable.row(tr);
...
function colorTaskId(data, type, row) {
    ...
    else if (row.status.completed) color = "#03a652";
    else color = "#524E4F";
...
},{"jquery":"hgMhh","datatables.net-dt":"emMEy","dayjs":"NJZFB","dayjs/plugin/advancedFormat":"aH65B","datatables.net-dt/css/jquery.dataTables.css":"4bH5s","dayjs/plugin/utc":"fhibK","dayjs/plugin/timezone":"8a2EL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"hgMhh":[function(require,module,exports) {
/*!
...
},{}]},["4XJ4A","faQa2"], "faQa2", "parcelRequire440f")

//# sourceMappingURL=scheduled-tasks.246180c7.js.map
