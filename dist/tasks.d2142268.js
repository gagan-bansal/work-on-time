...
})({"jdBgh":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "75fd7466d2142268";
...
},{}],"9JkT7":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
var _datatablesNetDt = require("datatables.net-dt");
var _datatablesNetDtDefault = parcelHelpers.interopDefault(_datatablesNetDt);
...
var _addTaskModalJs = require("./add-task-modal.js");
var _jqueryDataTablesCss = require("datatables.net-dt/css/jquery.dataTables.css");
var _stylesCss = require("../css/styles.css");
_dayjs.extend((0, _advancedFormatDefault.default));
const utc = require("dayjs/plugin/utc");
const timezone = require("dayjs/plugin/timezone"); // dependent on utc plugin
_dayjs.extend(utc);
_dayjs.extend(timezone);
(0, _datatablesNetDtDefault.default)();
const queryString = window.location.search;
const urlParams = new URLSearchParams(queryString);
const refreshInterval = urlParams.get("refreshInterval") || 30000;
if (urlParams.get("refresh")) window.setTimeout(function() {
    window.location.reload();
}, parseInt(refreshInterval) * 1000);
let taskTable;
loadTable();
function loadTable() {
    taskTable = (0, _jqueryDefault.default)("#tblTasks").DataTable({
        // data: data,
        ajax: {
            url: "./api/tasks",
        ...
        columns: [
            ...
            },
            {
                ...
                render: function(data, type, row) {
                    const isRunning = data.status.started && !data.status.completed && !data.status.failed && !data.status.stopped && !data.status.deleted;
                    let renderStr = "";
        ...
        initComplete: function(settings, json) {
            // init modal addTask
            _addTaskModalJs(taskTable);
        }
    });
    (0, _jqueryDefault.default)("#tblTasks tbody").on("click", ".btn-task-data", function() {
        var tr = (0, _jqueryDefault.default)(this).closest("tr");
        ...
        if (row.child.isShown()) {
            ...
            (0, _jqueryDefault.default)(btn).val("Task Data");
        } else {
            // Open this row
            ...
            tr.addClass("shown");
            (0, _jqueryDefault.default)(btn).val("Less");
        }
    });
    (0, _jqueryDefault.default)("#tblTasks tbody").on("click", ".btn-result", function() {
        var tr = (0, _jqueryDefault.default)(this).closest("tr");
        var row = taskTable.row(tr);
        var btn = this;
        // var btn = $(this).find('input')
        if (row.child.isShown()) {
            ...
            row.child.hide();
            tr.removeClass("shown");
            (0, _jqueryDefault.default)(btn).val("Result");
        } else {
            // Open this row
            //row.child( format(row.data()) ).show();
            const data = row.data();
    ...
    (0, _jqueryDefault.default)("#tblTasks tbody").on("click", ".btn-stop", function() {
        var tr = (0, _jqueryDefault.default)(this).closest("tr");
        var row = taskTable.row(tr);
        stopTask(row.data());
    });
    (0, _jqueryDefault.default)("#tblTasks tbody").on("click", ".btn-delete", function() {
        var tr = (0, _jqueryDefault.default)(this).closest("tr");
        var row = taskTable.row(tr);
        deleteTask(row.data());
    });
...
function formatDate(data, type, row) {
    if (data === "-") return data;
    return data ? _dayjs.tz(data, "Asia/Kolkata").format("YYYY-MM-DD kk:mm:ss") : "";
}
function colorTaskId(data, type, row) {
    ...
    if (color) return `<span style="color:${color};font-weight:bold;${row.status.deleted ? "text-decoration: line-through" : ""}">${data}</span>`;
    else return data;
}
// createCell functions
function formatStatus(td, data, rowData, row, col) {
    if (data === "done") (0, _jqueryDefault.default)(td).css("color", "green");
    if (data === "error") (0, _jqueryDefault.default)(td).css("color", "red");
    if (data === "running") (0, _jqueryDefault.default)(td).css("color", "orange");
}
...
},{"jquery":"hgMhh","datatables.net-dt":"emMEy","dayjs":"NJZFB","dayjs/plugin/advancedFormat":"aH65B","datatables.net-dt/css/jquery.dataTables.css":"4bH5s","dayjs/plugin/utc":"fhibK","dayjs/plugin/timezone":"8a2EL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","../css/styles.css":"792Rc","./add-task-modal.js":"22hv9"}],"hgMhh":[function(require,module,exports) {
/*!
...
},{}],"emMEy":[function(require,module,exports) {
 ...
 */ (function(factory) {
    ...
    module.exports = function(root, $) {
        if (!root) root = window;
        if (!$ || !$.fn.dataTable) // Require DataTables, which attaches to jQuery, including
...
},{"datatables.net":"gXxEN"}],"gXxEN":[function(require,module,exports) {
/*! DataTables 1.12.1
 ...
 */ /*jslint evil: true, undef: true, browser: true */ /*globals $,require,jQuery,define,_selector_run,_selector_opts,_selector_first,_selector_row_indexes,_ext,_Api,_api_register,_api_registerPlural,_re_new_lines,_re_html,_re_formatted_numeric,_re_escape_regex,_empty,_intVal,_numToDecimal,_isNumber,_isHtml,_htmlNumeric,_pluck,_pluck_order,_range,_stripHtml,_unique,_fnBuildAjax,_fnAjaxUpdate,_fnAjaxParameters,_fnAjaxUpdateDraw,_fnAjaxDataSrc,_fnAddColumn,_fnColumnOptions,_fnAdjustColumnSizing,_fnVisibleToColumnIndex,_fnColumnIndexToVisible,_fnVisbleColumns,_fnGetColumns,_fnColumnTypes,_fnApplyColumnDefs,_fnHungarianMap,_fnCamelToHungarian,_fnLanguageCompat,_fnBrowserDetect,_fnAddData,_fnAddTr,_fnNodeToDataIndex,_fnNodeToColumnIndex,_fnGetCellData,_fnSetCellData,_fnSplitObjNotation,_fnGetObjectDataFn,_fnSetObjectDataFn,_fnGetDataMaster,_fnClearTable,_fnDeleteIndex,_fnInvalidate,_fnGetRowElements,_fnCreateTr,_fnBuildHead,_fnDrawHead,_fnDraw,_fnReDraw,_fnAddOptionsHtml,_fnDetectHeader,_fnGetUniqueThs,_fnFeatureHtmlFilter,_fnFilterComplete,_fnFilterCustom,_fnFilterColumn,_fnFilter,_fnFilterCreateSearch,_fnEscapeRegex,_fnFilterData,_fnFeatureHtmlInfo,_fnUpdateInfo,_fnInfoMacros,_fnInitialise,_fnInitComplete,_fnLengthChange,_fnFeatureHtmlLength,_fnFeatureHtmlPaginate,_fnPageChange,_fnFeatureHtmlProcessing,_fnProcessingDisplay,_fnFeatureHtmlTable,_fnScrollDraw,_fnApplyToChildren,_fnCalculateColumnWidths,_fnThrottle,_fnConvertToWidth,_fnGetWidestNode,_fnGetMaxLenString,_fnStringToCss,_fnSortFlatten,_fnSort,_fnSortAria,_fnSortListener,_fnSortAttachListener,_fnSortingClasses,_fnSortData,_fnSaveState,_fnLoadState,_fnSettingsFromNode,_fnLog,_fnMap,_fnBindAction,_fnCallbackReg,_fnCallbackFire,_fnLengthOverflow,_fnRenderer,_fnDataSource,_fnRowAttributes*/ (function(factory) {
    ...
    module.exports = function(root, $) {
        if (!root) // CommonJS environments without a window global must pass a
    ...
    var DataTable = function(selector, options) {
		 ...
		 */ this.fnAddData = function(data, redraw) {
            ...
            /* Check if we want to add multiple rows or not */ var rows = Array.isArray(data) && (Array.isArray(data[0]) || $.isPlainObject(data[0])) ? api.rows.add(data) : api.row.add(data);
		 ...
		 */ this.fnAdjustColumnSizing = function(bRedraw) {
            ...
            else if (scroll.sX !== "" || scroll.sY !== "") /* If not redrawing, but scrolling, we want to apply the new column sizes anyway */ _fnScrollDraw(settings);
        };
        /**
        ...
        this.each(function() {
            ...
            /* Callback functions which are array driven */ _fnCallbackReg(oSettings, "aoDrawCallback", oInit.fnDrawCallback, "user");
            ...
            if (oLanguage.sUrl) {
                ...
                bInitHandedOff = true;
            } else _fnCallbackFire(oSettings, null, "i18n", [
                oSettings
            ]);
            /*
			 * Stripes
            ...
            /* Add the columns */ for(i = 0, iLen = aoColumnsInit.length; i < iLen; i++)_fnAddColumn(oSettings, anThs ? anThs[i] : null);
            /* Apply the column definitions */ _fnApplyColumnDefs(oSettings, oInit.aoColumnDefs, aoColumnsInit, function(iCol, oDef) {
            ...
            var loadedInit = function() {
                ...
                /* Check if there is data passing into the constructor */ if (oInit.aaData) for(i = 0; i < oInit.aaData.length; i++)_fnAddData(oSettings, oInit.aaData[i]);
                else if (oSettings.bDeferLoading || _fnDataSource(oSettings) == "dom") /* Grab the data from the page - only do this when deferred loading or no Ajax
            ...
            /* Must be done after everything which can be overridden by the state saving! */ _fnCallbackReg(oSettings, "aoDrawCallback", _fnSaveState, "state_save");
            if (oInit.bStateSave) {
	 ...
	 */ function _fnLanguageCompat(lang) {
        ...
        if (lang) {
            ...
            if (!lang.sEmptyTable && zeroRecords && defaults.sEmptyTable === "No data available in table") _fnMap(lang, lang, "sZeroRecords", "sEmptyTable");
	 ...
	 */ function _fnAddColumn(oSettings, nTh) {
        ...
        var oCol = $.extend({}, DataTable.models.oColumn, oDefaults, {
            "nTh": nTh ? nTh : document1.createElement("th"),
	 ...
	 */ function _fnColumnOptions(oSettings, iCol, oOptions) {
        ...
        if (typeof mDataSrc !== "number") oSettings._rowReadObject = true;
        /* Feature sorting overrides column specific when off */ if (!oSettings.oFeatures.bSort) {
            oCol.bSortable = false;
            th.addClass(oClasses.sSortableNone); // Have to add class here as order event isn't called
        }
        /* Check that the class assignment is correct for sorting */ var bAsc = $.inArray("asc", oCol.asSorting) !== -1;
	 ...
	 */ function _fnVisbleColumns(oSettings) {
        ...
        $.each(oSettings.aoColumns, function(i, col) {
            if (col.bVisible && $(col.nTh).css("display") !== "none") vis++;
        });
        return vis;
    }
    /**
        ...
        if (aoColDefs) /* Loop over the definitions array - loop in reverse so first instance has priority */ for(i = aoColDefs.length - 1; i >= 0; i--){
            ...
            for(j = 0, jLen = aTargets.length; j < jLen; j++){
                if (typeof aTargets[j] === "number" && aTargets[j] >= 0) {
                    /* Add columns that we don't yet know about */ while(columns.length <= aTargets[j])_fnAddColumn(oSettings);
                    ...
                    /* Class name matching on TH element */ for(k = 0, kLen = columns.length; k < kLen; k++)if (aTargets[j] == "_all" || $(columns[k].nTh).hasClass(aTargets[j])) fn(k, def);
                }
            }
        }
	 ...
	 */ function _fnAddData(oSettings, aDataIn, nTr, anTds) {
        ...
        /* Create the DOM information, or register it if already present */ if (nTr || !oSettings.oFeatures.bDeferRender) _fnCreateTr(oSettings, iRow, nTr, anTds);
        return iRow;
    }
    /**
	 ...
	 */ function _fnCreateTr(oSettings, iRow, nTrIn, anTds) {
        ...
        if (row.nTr === null) {
            nTr = nTrIn || document1.createElement("tr");
            row.nTr = nTr;
            row.anCells = cells;
            ...
            /* Process each column */ for(i = 0, iLen = oSettings.aoColumns.length; i < iLen; i++){
                ...
                nTd = create ? document1.createElement(oCol.sCellType) : anTds[i];
                nTd._DT_CellIndex = {
                    row: iRow,
                    column: i
                };
                ...
                if (create || (oCol.mRender || oCol.mData !== i) && (!$.isPlainObject(oCol.mData) || oCol.mData._ !== i + ".display")) nTd.innerHTML = _fnGetCellData(oSettings, iRow, i, "display");
	 ...
	 */ function _fnBuildHead(oSettings) {
        ...
        var columns = oSettings.aoColumns;
        if (createHeader) row = $("<tr/>").appendTo(thead);
        for(i = 0, ien = columns.length; i < ien; i++){
            column = columns[i];
        ...
        /* Deal with the footer - add classes if required */ $(thead).children("tr").children("th, td").addClass(classes.sHeaderTH);
        ...
        if (tfoot !== null) {
            ...
            for(i = 0, ien = cells.length; i < ien; i++){
                ...
                if (column.sClass) $(column.nTf).addClass(column.sClass);
            }
        }
    }
    /**
        ...
        for(i = 0, iLen = aoLocal.length; i < iLen; i++){
            ...
            for(j = 0, jLen = aoLocal[i].length; j < jLen; j++){
				 ...
				 */ if (aApplied[i][j] === undefined) {
                    ...
                    /* Do the actual expansion in the DOM */ $(aoLocal[i][j].cell).attr("rowspan", iRowspan).attr("colspan", iColspan);
                }
            }
        }
    }
	 ...
	 */ function _fnDraw(oSettings, ajaxComplete) {
        ...
        if (aiDisplay.length !== 0) {
            ...
            if (oSettings.iDraw == 1 && _fnDataSource(oSettings) == "ajax") sZero = oLang.sLoadingRecords;
	 ...
	 */ function _fnAddOptionsHtml(oSettings) {
        ...
        for(var i = 0; i < aDom.length; i++){
            ...
            cOption = aDom[i];
            if (cOption == "<") {
                /* New container div */ nNewNode = $("<div/>")[0];
            ...
            else if (cOption == "l" && features.bPaginate && features.bLengthChange) /* Length */ featureNode = _fnFeatureHtmlLength(oSettings);
            else if (cOption == "f" && features.bFilter) /* Filter */ featureNode = _fnFeatureHtmlFilter(oSettings);
            else if (cOption == "r" && features.bProcessing) /* pRocessing */ featureNode = _fnFeatureHtmlProcessing(oSettings);
            else if (cOption == "t") /* Table */ featureNode = _fnFeatureHtmlTable(oSettings);
            else if (cOption == "i" && features.bInfo) /* Info */ featureNode = _fnFeatureHtmlInfo(oSettings);
            else if (cOption == "p" && features.bPaginate) /* Pagination */ featureNode = _fnFeatureHtmlPaginate(oSettings);
            else if (DataTable.ext.feature.length !== 0) {
                /* Plug-in features */ var aoFeatures = DataTable.ext.feature;
	 ...
	 */ function _fnFeatureHtmlFilter(settings) {
        ...
        $(settings.nTable).on("search.dt.DT", function(ev, s) {
            ...
            try {
                if (jqFilter[0] !== document1.activeElement) jqFilter.val(previousSearch.sSearch);
            } catch (e) {}
        });
        return filter[0];
    }
	 ...
	 */ function _fnFilterComplete(oSettings, oInput, iForce) {
        ...
        /* In server-side processing all filtering is done by the server, so no point hanging around here */ if (_fnDataSource(oSettings) != "ssp") {
            /* Global filter */ _fnFilter(oSettings, oInput.sSearch, iForce, fnRegex(oInput), oInput.bSmart, oInput.bCaseInsensitive, oInput.return);
            fnSaveFilter(oInput);
            /* Now do the individual column filter */ for(var i = 0; i < aoPrevSearch.length; i++)_fnFilterColumn(oSettings, aoPrevSearch[i].sSearch, i, fnRegex(aoPrevSearch[i]), aoPrevSearch[i].bSmart, aoPrevSearch[i].bCaseInsensitive);
            /* Custom filtering */ _fnFilterCustom(oSettings);
        } else fnSaveFilter(oInput);
        /* Tell the draw function we have been filtering */ oSettings.bFiltered = true;
        _fnCallbackFire(oSettings, null, "search", [
            oSettings
        ]);
    }
    /**
	 ...
	 */ function _fnFilter(settings, input, force, regex, smart, caseInsensitive) {
        ...
        if (DataTable.ext.search.length !== 0) force = true;
	 ...
	 */ function _fnInitialise(settings) {
        ...
        /* Show the display HTML options */ _fnAddOptionsHtml(settings);
        /* Build and draw the header / footer for the table */ _fnBuildHead(settings);
        _fnDrawHead(settings, settings.aoHeader);
        _fnDrawHead(settings, settings.aoFooter);
        /* Okay to show that something is going on now */ _fnProcessingDisplay(settings, true);
        /* Calculate sizes for columns */ if (features.bAutoWidth) _fnCalculateColumnWidths(settings);
	 ...
	 */ function _fnFeatureHtmlLength(settings) {
        ...
        $(settings.nTable).on("length.dt.DT", function(e, s, len) {
            if (settings === s) $("select", div).val(len);
        });
        return div[0];
    }
    /* * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *
	 ...
	 */ function _fnPageChange(settings, action, redraw) {
        ...
        if (changed) {
            _fnCallbackFire(settings, null, "page", [
                settings
            ]);
	 ...
	 */ function _fnFeatureHtmlTable(settings) {
        ...
        if (scrollX) $(scrollBody).on("scroll.DT", function(e) {
	 ...
	 */ function _fnScrollDraw(settings) {
        ...
        _fnApplyToChildren(function(nSizer) {
            var style = window1.getComputedStyle ? window1.getComputedStyle(nSizer).width : _fnStringToCss($(nSizer).width());
        ...
        if (Math.round(table.outerWidth()) < Math.round(sanityWidth)) {
            ...
            if (ie67 && (divBodyEl.scrollHeight > divBodyEl.offsetHeight || divBody.css("overflow-y") == "scroll")) tableStyle.width = _fnStringToCss(correction - barWidth);
		 ...
		 */ if (!scrollY) /* IE7< puts a vertical scrollbar in place (when it shouldn't be) due to subtracting
			 ...
			 */ {
            if (ie67) divBodyStyle.height = _fnStringToCss(tableEl.offsetHeight + barWidth);
        }
	 ...
	 */ function _fnCalculateColumnWidths(oSettings) {
        ...
        /* Convert any user input sizes into pixel sizes */ for(i = 0; i < visibleColumns.length; i++){
		 ...
		 */ if (ie67 || !userInputs && !scrollX && !scrollY && columnCount == _fnVisbleColumns(oSettings) && columnCount == headerCells.length) for(i = 0; i < columnCount; i++){
            ...
            if (colIdx !== null) columns[colIdx].sWidth = _fnStringToCss(headerCells.eq(i).width());
        }
        else {
            ...
            for(i = 0; i < visibleColumns.length; i++){
                ...
                if (column.sWidthOrig && scrollX) $(headerCells[i]).append($("<div/>").css({
        ...
        if ((tableWidthAttr || scrollX) && !oSettings._reszEvt) {
            var bindResize = function() {
                $(window1).on("resize.DT-" + oSettings.sInstance, _fnThrottle(function() {
	 ...
	 */ function _fnConvertToWidth(width, parent) {
        if (!width) return 0;
        var n = $("<div/>").css("width", _fnStringToCss(width)).appendTo(parent || document1.body);
    ...
    function _fnSortFlatten(settings) {
        ...
        for(i = 0; i < nestedSort.length; i++){
            ...
            for(k = 0, kLen = aDataSort.length; k < kLen; k++){
                ...
                if (nestedSort[i]._idx === undefined) nestedSort[i]._idx = $.inArray(nestedSort[i][1], aoColumns[iCol].asSorting);
                aSort.push({
                    src: srcCol,
                    col: iCol,
                    dir: nestedSort[i][1],
	 ...
	 */ function _fnSortListener(settings, colIdx, append, callback) {
        ...
        var next = function(a, overflow) {
            var idx = a._idx;
            if (idx === undefined) idx = $.inArray(a[1], asSorting);
        ...
        _fnBindAction(attachTo, {}, function(e) {
            ...
            if (settings.oFeatures.bProcessing) {
                ...
                setTimeout(function() {
                    ...
                    // processing display
                    if (_fnDataSource(settings) !== "ssp") _fnProcessingDisplay(settings, false);
                }, 0);
	 ...
	 */ function _fnLog(settings, level, msg, tn) {
        ...
        if (!level) {
            ...
            if (settings) _fnCallbackFire(settings, null, "error", [
                settings,
                tn,
                msg
            ]);
        ...
        } else if (window1.console && console.log) console.log(msg);
    }
    /**
	 ...
	 */ var __table_selector = function(selector, a) {
        if (Array.isArray(selector)) return $.map(selector, function(item) {
	 ...
	 */ var __row_selector = function(settings, selector, opts) {
        ...
        var run = function(sel) {
            ...
            if (selInt !== null && $.inArray(selInt, rows) !== -1) // Selector - integer
            return [
                selInt
            ];
            ...
            return rows;
            // Selector - function
            if (typeof sel === "function") return $.map(rows, function(idx) {
                var row = aoData[idx];
    ...
    $(document1).on("plugin-init.dt", function(e, context) {
        ...
        if (loaded && loaded.childRows) api.rows($.map(loaded.childRows, function(id) {
            return id.replace(/:/g, "\\:");
        })).every(function() {
            _fnCallbackFire(context, null, "requestChild", [
                this
            ]);
        });
    });
    ...
    _api_register("destroy()", function(remove) {
        ...
        return this.iterator("table", function(settings) {
            ...
            $(window1).off(".DT-" + settings.sInstance);
            ...
            /* Remove the settings object from the settings array */ var idx = $.inArray(settings, DataTable.settings);
        ...
        pageButton: {
            _: function(settings, host, idx, buttons, page, pages) {
                ...
                try {
                    ...
                    // completed
                    activeEl = $(host).find(document1.activeElement).data("dt-idx");
                } catch (e) {}
    ...
    function __mld(dt, momentFn, luxonFn, dateFn, arg1) {
        if (window1.moment) return dt[momentFn](arg1);
        else if (window1.luxon) return dt[luxonFn](arg1);
    ...
    function __mldObj(d, format, locale) {
        var dt;
        if (window1.moment) {
            dt = window1.moment.utc(d, format, locale, true);
            if (!dt.isValid()) return null;
        } else if (window1.luxon) {
            dt = format ? window1.luxon.DateTime.fromFormat(d, format) : window1.luxon.DateTime.fromISO(d);
            if (!dt.isValid) return null;
            dt.setLocale(locale);
...
},{"jquery":"hgMhh"}],"NJZFB":[function(require,module,exports) {
!function(t, e) {
    module.exports = e();
}(this, function() {
    "use strict";
...
},{}],"4bH5s":[function() {},{}],"fhibK":[function(require,module,exports) {
!function(t, i) {
    module.exports = i();
}(this, function() {
    "use strict";
...
},{}],"792Rc":[function() {},{}],"22hv9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _jquery = require("jquery");
var _jqueryDefault = parcelHelpers.interopDefault(_jquery);
module.exports = function(taskTable) {
    ...
    window.onclick = function(event) {
        if (event.target == mpopup) mpopup.style.display = "none";
    };
    ...
    function populateWorkers(list) {
        (0, _jqueryDefault.default)("#selWorker").html("");
        list.forEach((worker)=>{
            (0, _jqueryDefault.default)("#selWorker").append(`<option value="${worker.name}">${worker.name}</options>`);
        });
    }
    async function postTask() {
        const worker = (0, _jqueryDefault.default)("#selWorker").val();
        const when = (0, _jqueryDefault.default)("#txtWhen").val();
        const data = (0, _jqueryDefault.default)("#taData").val();
        (0, _jqueryDefault.default).ajax({
            url: "./api/tasks",
            method: "POST",
            data: JSON.stringify({
...
},{"jquery":"hgMhh","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jdBgh","9JkT7"], "9JkT7", "parcelRequire440f")

//# sourceMappingURL=tasks.d2142268.js.map
